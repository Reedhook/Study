        ...
        <div class="row">
            <section class="content">
                <div class="col-12 mb-3 w-25">
                    <a href="{{route('admin.user.create')}}" class="btn btn-block btn-success">Создать</a>
                </div>
            </section>
        </div>
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('admin.user.delete',$user->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="border-0 bg-transparent"> <i class="fas fa-trash text-danger" role="button"></i>
                                            </button>
                                        </form>
                                    </td>
                                </tr>

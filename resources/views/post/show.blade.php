...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{$data->translatedFormat('F')}}
                *{{$data->day}}*{{$data->year}}*{{$data->format('H:i')}} {{$post->comments->count()}} Комментария</p>
                        ...
                        <form action="{{route('post.comment.store', $post->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    ...
                                    <textarea name="message" id="comment" class="form-control" placeholder="Комментарии"
                                              rows="10"></textarea>
                                </div>
                            </div>
                            <div class="row">
